...
import adapters.LawyersAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lawyerAdapter=new LawyerAdapter(getActivity(),lawyerList);
    ...
    private void fetchLawyerItems() {
        ...
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Gson gson=new Gson();
                Type listType=new TypeToken<List<Lawyer>>(){}.getType();
                try {
//                    JSONArray jsonArray = response.getJSONArray("lawyers");
        ...
        MyLawyers.getInstance().addToRequestQueue(jsonObjectRequest);
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder{
         ...
         public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView=LayoutInflater.from(parent.getContext()).inflate(R.layout.lawyer_row,parent,false);
          ...
          public void onBindViewHolder(@NonNull MyViewHolder holder,final int position) {
            ...
            final Lawyer lawyer=lawyerList.get(position);
//          Log.d("Lawyer id:",String.format("value = %d", lawyer.getId()));
            holder.lawyer_name.setText("Lawyer Name: " +lawyer.getName());
            holder.phone.setText("Contact: " +lawyer.getPhone());
            holder.specialization.setText("Specialization: " +lawyer.getSpecialization());
            holder.working_days.setText(("Work Days :"+lawyer.getWorkingDays()));
            holder.location.setText(("Location: " +lawyer.getLocation()));
                Log.d("image",lawyer.getProfileImg());
                Glide.with(context).load(lawyer.getProfileImg()).into(holder.thumbnail);
         }
